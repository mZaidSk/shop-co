...
const FooterNewsletter = () => {
    ...
    return (
        <div className="bg-black text-white m-2 p-8 rounded-2xl flex flex-col lg:flex-row items-center justify-between gap-6">
            {/* Left side - Heading */}
            <p className="font-extrabold text-2xl md:text-3xl lg:text-4xl text-center lg:text-left leading-tight">
                STAY UPTO DATE ABOUT <br className="hidden lg:block" /> OUR
                LATEST OFFERS
            </p>
