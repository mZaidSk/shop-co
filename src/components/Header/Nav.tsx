    ...
    <div>
      ...
      <nav className="flex items-center justify-between  px-4 py-3 bg-white shadow ">
        ...
        <div className="flex items-center gap-6 ">
          ...
          <Link to={'/'}> 
            <div 
            className="px-0 lg:px-12 text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold tracking-tight">
              SHOP.CO
            </div>
          </Link>
          ...
          <ul className="hidden xl:flex items-center lg:gap-6 text-lg lg:text-lg">
            ...
            <div className="relative" ref={shopRef}>
              ...
              {isShopClick && (
                <div className="absolute top-full left-0 mt-2 bg-[#f0f0f0] shadow-lg rounded-md py-2 w-48 z-990">
                  <NavLink
                    to="/shop/men"
      ...
      {/* Drawer (sm, md, lg) */}
        <div
      className={`fixed top-0 left-0 h-full w-64 bg-background shadow-lg transform transition-transform duration-300 z-999 ${
      ...
      {isDrawerOpen && (
        <div
          className="fixed inset-0 bg-transparent xl:hidden z-999"
          onClick={() => setIsDrawerOpen(false)}
        ></div>
      )}
    </div>
