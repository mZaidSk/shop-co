...
const CartPage = () => {
  ...
  return (
    <div className="pb-[3rem] m-auto md:w-[90%] w-[95%] mb-8">
          ...
          <div className="border border-[#0000001A] shadow-md rounded-2xl w-full md:w-3/5 h-fit py-4 px-3  ">
            {cartItems.map((item,index) => (
              <div key={index}
                  ...
                  <div
                    key={index}
                    className="flex items-center justify-evenly w-full h-fit gap-4  rounded-lg ">
                      <div className="h-22">
                        <img
                        src={item.image}
                        alt={item.name}
                        className="md:w-26 w-22 h-full  md:size-26 rounded-md object-cover"/>
                      </div>
                    <div className="   flex-1 md:w-2/4 flex flex-col justify-between h-22 md:h-26 ">
                      <div>
                    ...
                    <div className="flex flex-col items-end w-fit md:w-[200px] justify-between h-26">
                      <Trash2 
                      className="text-red-600 size-4 sm:size-5 cursor-pointer active:scale-90" 
                      ...
                      <div className="flex justify-around items-center w-fit px-2 h-6 md:h-8   bg-[#F0F0F0] gap-4 md:gap-6 rounded-[62px] ">
                          ...
                          >
                            <Minus className="size-3 md:size-4 text-base active:scale-90"/>
                          </button>
                          ...
                          <button
                            ...
                            className="cursor-pointer"
                          >
                            <Plus className="size-3 md:size-4 text-base active:scale-90"/>
                          </button>
                      </div>
                    </div>
                  </div>
